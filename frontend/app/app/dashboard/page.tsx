...
export default function DashboardPage() {
  return (
    <main className="w-full mx-auto px-4 sm:px-8 pt-4 pb-32 space-y-24 max-w-[1400px]">
      ...
      <section className="w-full space-y-8 opacity-0 animate-slide-up delay-200">
        ...
        <div className="flex overflow-x-auto gap-6 pb-8 snap-x snap-mandatory hide-scrollbar">
          ...
          <div className="snap-start shrink-0 w-[320px] h-[400px] bg-white border border-gray-200/50 rounded-[2rem] p-10 flex flex-col justify-between hover:-translate-y-2 hover:shadow-[0_12px_40px_rgb(0,0,0,0.08)] transition-all duration-300 ease-out cursor-pointer">
            <div>
          ...
          <Link href="/day/14" className="snap-start shrink-0 w-[320px] h-[400px] bg-espresso rounded-[2rem] p-10 flex flex-col justify-between group hover:-translate-y-3 hover:shadow-[0_20px_50px_rgba(217,119,87,0.25)] transition-all duration-400 ease-out cursor-pointer relative overflow-hidden">
          ...
          <div className="snap-start shrink-0 w-[320px] h-[400px] bg-paper-variant rounded-[2rem] p-10 flex flex-col justify-between opacity-80 border border-gray-200/50">
            <div>
